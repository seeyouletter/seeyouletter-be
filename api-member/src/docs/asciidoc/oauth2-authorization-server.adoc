...
=== Request parameters
include::{snippets}/authorization/query-parameters.adoc[]
...
=== Request parameters
include::{snippets}/token/form-parameters.adoc[]
...
=== Request parameters
include::{snippets}/introspect/form-parameters.adoc[]
...
=== Request parameters
include::{snippets}/revoke/form-parameters.adoc[]
